CREATE TYPE "public"."moderation_action_kind" AS ENUM('ban', 'unban', 'suspend', 'unsuspend', 'mute', 'unmute', 'remove_video', 'restore_video', 'hard_delete_video', 'remove_comment', 'restore_comment', 'hard_delete_comment', 'role_change', 'delete_user', 'resolve_report', 'dismiss_report');--> statement-breakpoint
CREATE TYPE "public"."moderation_target_kind" AS ENUM('user', 'video', 'comment', 'report');--> statement-breakpoint
...
CREATE TABLE "moderation_action" (
	...
	"target_type" "moderation_target_kind" NOT NULL,
